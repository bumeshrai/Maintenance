        ...
        btView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(rb!=null){
                    ...
                    Toast.makeText(getApplicationContext(),"Select a contractor!!",Toast.LENGTH_SHORT).show();
            }
        });
            ...
            public void onResponse(String response) {
                try {
                    ...
                    for(int i = 0 ; i < dataArray.length(); i++){
                        ...
                        new CreateLayout(ViewLocationActivity.this,viewLocationLayout).createRadioButton(org,radioId++,radioGroup);
                        //Log.i("value1",org);
                    }
