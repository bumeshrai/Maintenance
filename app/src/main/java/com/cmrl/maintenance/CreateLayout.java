...
public class CreateLayout{
    ...
    Context context;
    LinearLayout.LayoutParams textParams, editParams,checkBoxParams,buttonParams,spinnerParams;;
    ...
    void createEditText(String hint) {
    ...
    public void createRadioButton(String org, Integer bdId, RadioGroup radioGroup) {
        RadioButton radioButton = new RadioButton(context);
        radioButton.setText(org);
        radioButton.setPadding(20, 20, 20, 20);
        radioButton.setTextSize(18);
        radioButton.setId(bdId);
        radioButton.setTypeface(Typeface.defaultFromStyle(Typeface.BOLD));
        radioGroup.addView(radioButton);
    }

    public void createSpinner(ArrayList<String> list, List<Spinner> spinnerList) {
        final Spinner spinner = new Spinner(context);
        spinner.setLayoutParams(spinnerParams);
        spinner.setBackgroundResource(R.drawable.rounded_lightblue);
        ...
        builder.setTitle("Do you want to proceed?")
                ...
                .setPositiveButton("YES", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        createIntent.putExtra("urlParams",SaveData.EQUIPMENT.toLowerCase()+"/create");
